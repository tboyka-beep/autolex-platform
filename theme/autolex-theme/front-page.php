    ...
    <div class="alx-container alx-home-grid">
        ...
        <section class="alx-hero" aria-labelledby="alx-home-title">
            <div class="alx-hero-copy">
                ...
                <form class="alx-vehicle-search" role="search" action="<?php echo esc_url(home_url('/autok/')); ?>" method="get">
                    <div class="alx-search-tabs" aria-label="<?php esc_attr_e('Keresési mód', 'autolex-theme'); ?>">
                        <span aria-current="true"><?php esc_html_e('Jármű keresése', 'autolex-theme'); ?></span>
                        <span><?php esc_html_e('Alvázszám (VIN)', 'autolex-theme'); ?></span>
                        <span><?php esc_html_e('Motorkód', 'autolex-theme'); ?></span>
                    </div>
                    <div class="alx-search-fields">
                        ...
                        <label><span><?php esc_html_e('Évjárat', 'autolex-theme'); ?></span><input name="year" inputmode="numeric" placeholder="<?php esc_attr_e('Évjárat', 'autolex-theme'); ?>"></label>
