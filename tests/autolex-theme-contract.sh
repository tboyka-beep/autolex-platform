...
grep -Fq "is_page('tudastar')" "$THEME/page.php"
grep -Fq 'id="alx-knowledge-title"' "$THEME/page.php"
grep -Fq 'aria-live="polite"' "$THEME/page.php"
grep -Fq 'alx-knowledge-plugin-output' "$THEME/page.php"
grep -Fq 'get_the_content()' "$THEME/page.php"
grep -Fq 'alx-knowledge-empty' "$THEME/page.php"
grep -Fq 'id="muszaki-alapok"' "$THEME/page.php"
grep -Fq 'id="biztonsag"' "$THEME/page.php"
grep -Fq '.alx-knowledge-workspace' "$THEME/assets/css/content.css"
grep -Fq 'grid-template-columns: repeat(2' "$THEME/assets/css/content.css"
grep -Fq '.alx-knowledge-grid' "$THEME/assets/css/content.css"
